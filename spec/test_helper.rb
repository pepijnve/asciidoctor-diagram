...
require 'asciidoctor-diagram/blockdiag/extension'
require 'asciidoctor-diagram/ditaa/extension'
require 'asciidoctor-diagram/erd/extension'
require 'asciidoctor-diagram/graphviz/extension'
require 'asciidoctor-diagram/meme/extension'
require 'asciidoctor-diagram/mermaid/extension'
require 'asciidoctor-diagram/plantuml/extension'
require 'asciidoctor-diagram/shaape/extension'
require 'asciidoctor-diagram/umlet/extension'
require 'asciidoctor-diagram/wavedrom/extension'
